                    ...
                    <?php echo form_open(site_url() . 'signin/signinSubmit', array('enctype' => 'multipart/form-data', 'id' => 'signin-form'));?>
                        ...
                        <div class="row">
                            <div class="col-md-12 mb-1">
                                <label for="username" class="form-label"><?= translate('username'); ?> / <?= translate('email'); ?></label>
                                <input type="text" class="form-control form-control-lg form-bingo" name="username" id="username" placeholder="<?= translate('username'); ?> / <?= translate('email'); ?>" autofocus autocomplete="off">
...
<div id="g_id_onload" data-client_id="171600430722-0qca96ur0h4nsak8p1r699j11b1n1dqn.apps.googleusercontent.com" data-callback="handleCredentialResponse" data-auto_prompt="true">
</div>
