                    ...
                    <?php echo form_open(site_url() . 'signin/signinSubmit', array('enctype' => 'multipart/form-data', 'id' => 'signin-form'));?>
                        ...
                        <div class="row">
                            <div class="col-md-12 mb-1">
                                ...
                                <input type="text" class="form-control form-control-lg form-bingo" name="username" id="username" placeholder="Nombre o correo electrónico" autofocus autocomplete="off">
