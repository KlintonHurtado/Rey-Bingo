...
class GamesModel extends Model {
    ...
    protected $allowedFields = ['user', 'room', 'description', 'modalities', 'price', 'min_players', 'min_cartons', 'allow_roulette_cartons', 'date', 'time', 'award', 'type', 'url', 'video', 'reset', 'cover', 'created_at', 'updated_at', 'status'];
