...
class UsersModel extends Model {
    ...
    protected $allowedFields = ['code', 'group', 'admin_role_id', 'wallet', 'wallet_recharge', 'wallet_withdraw', 'wallet_bonus', 'kyc_status', 'kyc_front', 'kyc_back', 'kyc_selfie', 'kyc_observations', 'document', 'document_expires_at', 'firstname', 'lastname', 'business_name', 'store_commission_rate', 'store_prize_commission_rate', 'operator_commission_rate', 'ggr_commission_rate', 'affiliate_cpa_amount', 'username', 'password', 'email', 'phone', 'address_line', 'city', 'state', 'is_reseller', 'bank', 'account', 'account_type', 'remember_token', 'created_at', 'updated_at', 'sounds', 'narration', 'autodial', 'image', 'verification_token', 'verified_email', 'terms_accepted_at', 'restore_code', 'restore_token', 'referred_code', 'referred_store_id', 'affiliate_signup_store_id', 'operator_id', 'referred_operator_id', 'status', 'deleted', 'roulette', 'low_balance_alert', 'last_ip', 'last_mac', 'last_seen_at'];
