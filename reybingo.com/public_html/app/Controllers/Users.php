...
class Users extends Controller {
    ...
    public function userSubmit() {
        ...
        $data = [
            ...
            'sounds' => ($group === bingo_group_admin() || $pageMode) ? 0 : (int) ($this->request->getPost('sounds') ?? 1),
            'narration' => ($group === bingo_group_admin() || $pageMode) ? 0 : (int) ($this->request->getPost('narration') ?? 1),
            'autodial' => ($group === bingo_group_admin() || $pageMode) ? 0 : (int) ($this->request->getPost('autodial') ?? 1),
            'roulette' => ($group === bingo_group_admin() || $pageMode) ? 0 : (int) ($this->request->getPost('roulette') ?? 1),
