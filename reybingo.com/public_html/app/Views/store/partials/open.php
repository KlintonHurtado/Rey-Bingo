    ...
    <div class="store-panel-shell">
        <aside class="store-panel-sidebar">
            <div class="card store-panel-card store-panel-sidebar-card">
                <div class="card-body">
                    <?php $storeDisplayName = trim(bingo_store_display_name($user ?? [])); ?>
                    ...
                    <div class="store-sidebar-stats">
                        ...
                        <div class="store-commission-sidebar">
                            ...
                            <strong class="store-commission-rate"><?= number_format(bingo_store_commission_rate($user ?? []) * 100, 2) ?>%</strong>
                        </div>
                        <div class="store-commission-sidebar">
                            <span class="store-balance-label"><?= translate('store prize commission rate'); ?></span>
                            <strong class="store-commission-rate"><?= number_format(bingo_store_prize_commission_rate($user ?? []) * 100, 2) ?>%</strong>
                        </div>
                    </div>
