...
<head>
    ...
    <style>
        ...
        #content-page {
            ...
            flex-direction: column;
            min-height: 100vh;
            padding-bottom: 60px; /* Altura de la barra de navegación inferior */
            position: relative;
        }
        ...
        /* Estilos para el contenido principal con desplazamiento */
        .main-content {
            flex: 1;
        ...
        /* Estilos base para los elementos del menú inferior */
        ...
        /* Contenedor de cada ítem del menú */
        .bottom-navbar .nav-item .d-flex {
            padding: 8px 0;
            width: 100%;
            transition: all 0.3s ease;
        }
        ...
        /* Estilos específicos para el botón central */
        .center-button {
            ...
            box-shadow: 0 4px 10px rgba(0, 97, 255, 0.5);
        ...
        .center-button:hover {
            ...
            box-shadow: 0 6px 15px rgba(0, 97, 255, 0.7);
            cursor: pointer;
        }
        ...
        /* Excluir el ítem del botón central de algunos efectos */
        .bottom-navbar .nav-item.position-relative::after {
            display: none; /* Elimina la línea de hover para el botón central */
        }

        .bottom-navbar .nav-item.position-relative:hover .d-flex,
        .bottom-navbar .nav-item.position-relative.active .d-flex {
            transform: none; /* Evita la animación de elevación para el contenedor del botón central */
        }

        /* Efecto hover para los ítems del menú (excepto el botón central) */
        .bottom-navbar .nav-item:not(.position-relative):hover .d-flex,
        .bottom-navbar .nav-item:not(.position-relative).active .d-flex {
            transform: translateY(-5px);
        }

        .bottom-navbar .nav-item:not(.position-relative):hover i,
        .bottom-navbar .nav-item:not(.position-relative).active i {
            transform: scale(1.2);
            color: #60efff;
            text-shadow: 0 0 10px rgba(96, 239, 255, 0.5);
        }

        .bottom-navbar .nav-item:not(.position-relative):hover .nav-text,
        .bottom-navbar .nav-item:not(.position-relative).active .nav-text {
            color: #60efff;
            font-weight: 500;
        }

        /* Efecto al hacer clic (active state) */
        .bottom-navbar .nav-item:not(.position-relative):active .d-flex {
        ...
        /* Indicador de ítem activo (punto o barra) */
        .bottom-navbar .nav-item:not(.position-relative)::after {
            content: '';
            position: absolute;
            bottom: 0;
            left: 50%;
        ...
        .bottom-navbar .nav-item:not(.position-relative):hover::after,
        .bottom-navbar .nav-item:not(.position-relative).active::after {
            width: 40%;
            opacity: 1;
        }

        /* Efecto de onda al hacer clic */
        .bottom-navbar .nav-item .ripple {
            position: absolute;
        ...
        .action-icon-wrapper.depositar {
            background: linear-gradient(135deg, #11998e, #38ef7d);
        }

        .action-icon-wrapper.retirar {
            background: linear-gradient(135deg, #f46b45, #eea849);
        }

        .action-icon-wrapper.cartones {
            background: linear-gradient(135deg, #4e54c8, #8f94fb);
        }

        .action-icon-wrapper.solicitudes {
        ...
        @media (max-width: 576px) {
            ...
            .container {
                padding-bottom: 70px; /* Espacio adicional en la parte inferior */
            }
        }
    </style>
</head>
...
<?= view('layout/_layout_user_bootstrap') ?>
    ...
    <div class="container-fluid" id="content-page">
        <?php if (session()->get('logged_in')) : ?>
            ...
            <nav class="top-navbar">
                <div class="container-fluid">
                    <div class="row align-items-center">
                        ...
                        <div class="col-3">
                            <button class="btn text-white ms-2" type="button" data-bs-toggle="offcanvas" data-bs-target="#sideMenu">
                        ...
                        <div class="col-6 logo-container">
                            <img src="<?= site_url('assets/img/logo.png'); ?>" alt="Bingo Live Logo">
                        </div>
                        
                        <!-- Right side - Profile -->
                        <div class="col-3 profile-menu">
                            <div class="dropdown float-end me-2">
                                <a class="btn text-white dropdown-toggle" href="javascript:void(0);" role="button" data-bs-toggle="dropdown">
            ...
            <!-- Side Menu (Offcanvas) -->
            <div class="offcanvas offcanvas-start" tabindex="-1" id="sideMenu" style="width: 220px;">
                <div class="offcanvas-header bg-primary text-white">
                    <h5 class="offcanvas-title text-uppercase"><?= APP_NAME; ?></h5>
                    <button class="btn-close text-reset" type="button" aria-label="close" data-bs-dismiss="offcanvas"><i class="fa-duotone fa-solid fa-xmark"></i></button>
                </div>
                <div class="offcanvas-body">
                    <ul class="nav flex-column">
                        ...
                        <?php if (session()->get('group') == 0) : ?>
                            <li class="nav-item">
                                <a class="nav-link" href="javascript:void(0);"><i class="fa-duotone fa-solid fa-ticket-alt me-2"></i><?= translate('deposit'); ?></a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" onclick="depositGet();" href="javascript:void(0);"><i class="fa-duotone fa-arrow-down-to-bracket me-2"></i><?= translate('deposit'); ?></a>
                            </li>
                            <li class="nav-item">
            ...
            <nav class="bottom-navbar bg-primary">
                <div class="container h-100">
                    <div class="row h-100 align-items-center">
                        <div class="col nav-item">
                            <div class="d-flex flex-column align-items-center">
                                <i class="fa-duotone fa-solid fa-home"></i>
                                <span class="nav-text">Inicio</span>
                            </div>
                        </div>
                        <div class="col nav-item" onclick="paymentsGet();">
                            <div class="d-flex flex-column align-items-center">
                                <i class="fa-duotone fa-solid fa-wallet"></i>
                                <span class="nav-text">Billetera</span>
                            </div>
                        </div>
                        <div class="col nav-item position-relative">
                            <div class="center-button position-absolute top-50 start-50 translate-middle">
    ...
    <script type="text/javascript">
        ...
        let soundnotify;
        let hasPlayedSound = false; // Flag para controlar si ya se reprodujo el sonido
        ...
        if (!wheel) { /* ruleta no presente en esta vista */ } else {
        ...
        function claimPrize() {
            const claimBtn = document.getElementById('claimBtn');
            const cartons = claimBtn.dataset.cartons || 0;
