...
<?= view('layout/_layout_user_bootstrap') ?>
    ...
    <!-- loader -->
    <div id="loader">
        <img src="assetsNew/img/loading-icon.png" alt="icon" class="loading-icon">
    </div>
    <!-- * loader -->
    ...
    <div class="appHeader bg-primary text-light">
        ...
        <div class="pageTitle">
            <img src="assetsNew/img/icon/logo.svg" alt="logo" class="logo">
        </div>
        <div class="right">
            ...
            <a href="app-settings.html" class="headerButton">
                <img src="<?= $imagePath ?>" alt="image" class="imaged w32">
    ...
    <div class="appBottomMenu">
        ...
        <a href="javascript:void(0);" class="item" onclick="gameAdd();" data-toggle="tooltip" data-placement="top" title="Agregar juego">
            <div class="col">
                ...
                <div class="modal-body p-0">
                    ...
                    <div class="profileBox pt-2 pb-2">
                        <div class="image-wrapper">
                            <img src="<?= $imagePath ?>" alt="image" class="imaged  w36">
                        </div>
                        <div class="in">
                            <strong><?= translate('hello'); ?>, <?= $user['firstname']; ?></strong>
                            <div class="text-muted"><?= $user['code']; ?></div>
                        </div>
                    ...
                    <div class="sidebar-balance">
                        <div class="listview-title"><?= translate('available my wallet'); ?></div>
                        <div class="in">
                            <h1 class="amount"><?= systemGet('currency'); ?> <?= number_format($user['wallet'], 2); ?></h1>
                        </div>
                    </div>
                    <!-- * balance -->
                    ...
                    <ul class="listview image-listview flush transparent no-line">
                        <li>
                            <a href="#" class="item">
                                <img src="assetsNew/img/sample/avatar/avatar2.jpg" alt="image" class="image">
                                <div class="in">
                        ...
                        <li>
                            <a href="#" class="item">
                                <img src="assetsNew/img/sample/avatar/avatar4.jpg" alt="image" class="image">
                                <div class="in">
                        ...
                        <li>
                            <a href="#" class="item">
                                <img src="assetsNew/img/sample/avatar/avatar3.jpg" alt="image" class="image">
                                <div class="in">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="action-sheet-content text-center">
                        <div class="mb-1"><img src="assetsNew/img/icon/192x192.png" alt="image" class="imaged w64 mb-2">
                        </div>
                        <div>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="action-sheet-content text-center">
                        <div class="mb-1">
                            <img src="assetsNew/img/icon/192x192.png" alt="image" class="imaged w64 mb-2">
                        </div>
                        <div>
    ...
    <script src="https://code.jquery.com/jquery-3.6.0.min.js"></script>
    <!-- Bootstrap -->
    <script src="assetsNew/js/lib/bootstrap.bundle.min.js"></script>
    <!-- Ionicons -->
    <script type="module" src="https://cdn.jsdelivr.net/npm/ionicons@latest/dist/ionicons/ionicons.esm.js"></script>
    <!-- Splide -->
    <script src="assetsNew/js/plugins/splide/splide.min.js"></script>
    <!-- Base Js File -->

    <script src="<?= asset_url('js/app.js') ?>"></script>
    <script src="<?= asset_url('js/toastify.js') ?>"></script>
    <script src="<?= asset_url('js/sweetalert.js') ?>"></script>
    <script src="assetsNew/js/base.js"></script>
