            ...
            <?php echo form_open(site_url() . 'games/gameSubmit', array('enctype' => 'multipart/form-data', 'id' => 'game-form'));?>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 mb-1">
                        ...
                        <input type="number" class="form-control form-control-lg form-bingo format" name="price" id="price" placeholder="<?= translate('enter a'); ?> <?= strtolower(translate('price')); ?>" autocomplete="off" value="0" min="0" max="9999" step="0.01" inputmode="decimal">
