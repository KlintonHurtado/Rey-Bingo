                    ...
                    <div class="d-flex justify-content-between align-items-start gap-3 mb-3">
                        <div>
                            ...
                            <p class="text-muted small mb-0">
                                Aquí aparecen los cartones que reclamaste en la ruleta. Solo puedes usarlos en partidas con cartón a <?= $currency; ?> 0.50 o menos.
                            </p>
                        </div>
                    ...
                    <div id="won-cartons-list">
                        ...
                        <?php if (! empty($pendingPrizes) && empty($gameOptions)) : ?>
                            <div class="alert alert-warning mt-3 mb-0">
                                Tienes cartones pendientes, pero no hay partidas activas con cartón a <?= $currency; ?> 0.50 o menos.
                            </div>
                        <?php endif; ?>
                    </div>
                </div>
